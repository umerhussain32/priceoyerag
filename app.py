...
The **Reason** is that on **GPT OSS Safeguard 20B**(openai/gpt-oss-safeguard-20b) model **Groq Api** only provides **8000** tokens limit per request, exceeding or requesting tokens above this limit may return **ERROR**. And also I have optimized the **prompts** to keep system within token limits. \n
